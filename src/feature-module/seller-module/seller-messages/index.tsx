                ...
                >
                  <div className="mb-0">
                    ...
                    <div className="left-chat-title all-chats">
                      <div className="select-group-chat mb-2">
                        <Link to="#">Toutes les conversations</Link>
                      </div>
                      <div className="add-section">
                        {/* Chat Search */}
                        <div className="input-icon">
                          <span className="input-icon-addon">
                            <i className="feather icon-search fs-14" />
                          </span>
                          <input
                            type="email"
                  ...
                  <div className="chat-body chat-page-group slimscroll">
                    <div className="messages">
                      ...
                      <div className="chat-line">
                        <span className="chat-date">Aujourd'hui, 24 juillet</span>
                      </div>
                          ...
                          <div className="message-content ">
                            ...
                            <div className="chat-voice-group">
                              <ul>
                                ...
                                <li>
                                  <ImageWithBasePath src="assets/img/voice.svg" alt="image" />
                                </li>
                                <li>0:05</li>
                              </ul>
                            </div>
                          ...
                          <div className="like-chat-grp">
                            <ul>
                              <li className="like-chat">
                                <Link to="#">
                                  2
                                  <ImageWithBasePath src="assets/img/icons/like.svg" alt="Icon" />
                                </Link>
                              </li>
