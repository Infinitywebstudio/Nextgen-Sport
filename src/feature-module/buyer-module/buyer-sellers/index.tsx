                ...
                <div className="card-body text-center">
                  ...
                  <p className="mb-0 location-text d-inline-flex align-items-center">
                    <ImageWithBasePath
                      ...
                      className="me-1"
                    />
                    Malaysia <i className="ti ti-point-filled mx-1" /> Total
                    Gigs : 12
                  </p>
                </div>
              </div>
                ...
                <div className="card-body text-center">
                  ...
                  <p className="mb-0 location-text d-inline-flex align-items-center">
                    <ImageWithBasePath
                      ...
                      className="me-1"
                    />
                    USA <i className="ti ti-point-filled mx-1" /> Total Gigs :
                    15
                  </p>
                </div>
              </div>
                ...
                <div className="card-body text-center">
                  ...
                  <p className="mb-0 location-text d-inline-flex align-items-center">
                    <ImageWithBasePath
                      ...
                      className="me-1"
                    />
                    Turkey <i className="ti ti-point-filled mx-1" /> Total Gigs
                    : 22
                  </p>
                </div>
              </div>
                ...
                <div className="card-body text-center">
                  ...
                  <p className="mb-0 location-text d-inline-flex align-items-center">
                    <ImageWithBasePath
                      ...
                      className="me-1"
                    />
                    Singapore <i className="ti ti-point-filled mx-1" /> Total
                    Gigs : 21
                  </p>
                </div>
              </div>
                ...
                <div className="card-body text-center">
                  ...
                  <p className="mb-0 location-text d-inline-flex align-items-center">
                    <ImageWithBasePath
                      ...
                      className="me-1"
                    />
                    UAE <i className="ti ti-point-filled mx-1" /> Total Gigs :
                    39
                  </p>
                </div>
              </div>
