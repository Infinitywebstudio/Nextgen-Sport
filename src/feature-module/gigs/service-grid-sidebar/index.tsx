    ...
    <>
            ...
            <div className="col-md-12 col-12">
              <nav aria-label="breadcrumb" className="page-breadcrumb">
                <ol className="breadcrumb">
                  ...
                  <li className="breadcrumb-item">
                    <Link to={routes.service}>Home</Link>
                  </li>
      ...
      <div className="page-content">
        <div className="container">
          ...
          {/* Service Slider */}
          <div className="trend-section server-grid-slider">
            <div className="row">
            ...
            <div className="service-sliders owl-carousel">
              <Slider {...serviceslideroption}>
                <div className="service-box">
                  <div className="service-info">
                    <div className="servive-name">
                      <h5>
                        <Link to={routes.serviceGridSidebar}>Website Promotion</Link>
                      </h5>
                      <p>(80 Services)</p>
                    </div>
                  </div>
                ...
                <div className="service-box">
                  <div className="service-info">
                    <div className="servive-name">
                      <h5>
                        <Link to={routes.serviceGridSidebar}>Ecommerce-Seo</Link>
                      </h5>
                      <p>(42 Services)</p>
                    </div>
                  </div>
                ...
                <div className="service-box">
                  <div className="service-info">
                    <div className="servive-name">
                      <h5>
                        <Link to={routes.serviceGridSidebar}>Promoted Listing</Link>
                      </h5>
                      <p>(24 Services)</p>
                    </div>
                  </div>
                ...
                <div className="service-box">
                  <div className="service-info">
                    <div className="servive-name">
                      <h5>
                        <Link to={routes.serviceGridSidebar}>Social Ecommerce</Link>
                      </h5>
                      <p>(55 Services)</p>
                    </div>
                  </div>
