...
import { location, Quantity, What } from '../../../core/common/selectOption';
    ...
    <>
      ...
      <div className="breadcrumb-bar breadcrumb-bar-info breadcrumb-info">
        ...
        <div className="container">
          ...
          <h2 className="breadcrumb-title">Gigs Details 2</h2>
        </div>
      </div>
      {/* /Breadcrumb */}
      {/* Content */}
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-8">
              {/* Breadcrumb */}
              <div className="breadcrumb-bar breadcrumb-bar-info breadcrumb-info text-start pt-0 bg-white">
                <Link
                  to="#"
                  className="badge bg-light mb-4 text-dark"
                >
                  Website Promotion
                </Link>
              ...
              {/* /Breadcrumb */}
              {/* Slider */}
              <div className="slider-card service-slider-card">
              ...
              {/* /Slider */}
              <div className="row gx-3 row-gap-3 mb-4 statistics">
                <div className="col-xl-3 col-lg-6 col-sm-4 col-6">
                  <div className="buy-box">
                    <i className="ti ti-clock-hour-2 text-secondary" />
                    <p>Delivery Time</p>
                    <h6>15 day</h6>
                  </div>
                </div>
                <div className="col-xl-3 col-lg-6 col-sm-4 col-6">
                  <div className="buy-box">
                    <i className="ti ti-cloud-fog text-purple" />
                    <p>Total Sales</p>
                    <h6>15</h6>
                  </div>
                </div>
                <div className="col-xl-3 col-lg-6 col-sm-4 col-6">
                  <div className="buy-box">
                    <i className="ti ti-eye-star text-indigo" />
                    <p>Total Views</p>
                    <h6>800</h6>
                  </div>
                </div>
                <div className="col-xl-3 col-lg-6 col-sm-4 col-6">
                  <div className="buy-box">
                    <i className="ti ti-messages text-teal" />
                    <p>Extra Services</p>
                    <h6>05</h6>
                  </div>
                </div>
              ...
              <div className="tab-content">
                ...
                >
                  ...
                  <div className="service-wrap">
                    ...
                    <p>
                      ...
                      Autoblog for Making Money Online Affiliate marketing is an
                      excellent way to earn passive income. this type of website
                      doesn't require any extra maintenance or technical knowledge
                      to run.
                    </p>
                    <p>
                      Every product will be linked with your unique affiliate ID so
                      that you will earn commissions on every sale. Autoblog Feature
                      will automatically add high-quality blog content relevant to
                      your niche to the site. No maintenance is required!With my
                      service, you will get a Complete Automatic amazon affiliate
                      website with auto blogs for passive income.
                    </p>
                  </div>
                  {/* /About Gigs */}
                </div>
                <div className="tab-pane fade " id="work_me" role="tabpanel">
                  {/* Why Work With Me */}
                ...
                <div className="tab-pane fade " id="recent_works" role="tabpanel">
                  {/* Recent Works */}
                  <div className="service-wrap">
            ...
            <div className="col-lg-4">
              <div className="theiaStickySidebar"> 
                <div className="service-widget">
                  <div className="service-amt p-3 price-lvl price-lvl bg-dark ">
                    <h3 className="">
                ...
                <div className="service-widget member-widget">
                  ...
                  <div className="about-me new-about">
                    <h6>About Me</h6>
                    <p>
                      Hello, Greetings! My name is Adrian, and I am an experienced
                      affiliate marketer and website developer
                      {isReadMore && (
                      <span className="more-content">
                        I have over five years experience in digital affiliate
                        marketing &amp; WordPress website development.
                      </span>
                    )}
                    </p>
                  ...
                  <div className="member-info member-info-new">
                    <div className="member-list d-flex align-items-center gap mb-3">
                      <i className="ti ti-clock-hour-5" />
                      <h6 className="mb-0">
                        Response Time
                        <span className="pt-2"> 25 Jan 2018</span>
                      </h6>
                    </div>
                    <div className="member-list d-flex align-items-center gap mb-3">
                      ...
                      <h6 className="mb-0">
                        ...
                        <span className="pt-2">
                          {" "}
                          Average Response Time About 8 Hours
                        </span>
                      </h6>
                    </div>
                    <div className="member-list d-flex align-items-center gap mb-3">
                      ...
                      <h6 className="mb-0">
                        ...
                        <span className="pt-2"> 25 January 2025, 10:15PM</span>
                      </h6>
                    </div>
                    <div className="member-list d-flex align-items-center gap">
                      <i className="ti ti-world-check" />
                      <h6 className="mb-0">
                        Language
                        <span className="pt-2">
                          {" "}
                          I Know English, Japanese and Portugese{" "}
                        </span>
                      </h6>
                    </div>
                  </div>
                ...
                <div className="service-widget">
                  <h5 className="">Share This Gig</h5>
                  <div className="social-links d-flex align-items-center breadcrumb-social pt-2">
                    <ul>
                      <li>
                        <Link to="#">
