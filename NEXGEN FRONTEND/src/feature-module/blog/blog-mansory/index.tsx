        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 col-12">
              ...
              <h2 className="breadcrumb-title">Blog Mansory</h2>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="col-lg-12 col-md-12">
                    <div className="blog-grid">
                      <div className="blog-img">
                        <Link to={routes.blogDetails}>
                          <ImageWithBasePath
                            src="assets/img/blog/blog-mansory-03.jpg"
                            className="img-fluid"
                            alt="img"
                          />
                        </Link>
                  ...
                  <div className="col-lg-12 col-md-12">
                    <div className="blog-grid">
                      <div className="blog-img">
                        <Link to={routes.blogDetails}>
                          <ImageWithBasePath
                            src="assets/img/blog/blog-mansory-01.jpg"
                            className="img-fluid"
                            alt="img"
                          />
                        </Link>
                  ...
                  <div className="col-xl-12 col-md-6">
                    <div className="blog-grid">
                      <div className="blog-img">
                        <Link to={routes.blogDetails}>
                          <ImageWithBasePath
                            src="assets/img/blog/blog-mansory-02.jpg"
                            className="img-fluid"
                            alt="img"
                          />
                        </Link>
