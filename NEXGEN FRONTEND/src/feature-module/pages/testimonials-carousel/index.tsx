...
const TestimonialsCarousel = () => {
  ...
  const testimonialCarousel = {
    ...
    slidesToScroll: 1,
    autoplay: false,
    arrows: false, // matches nav: false
    responsive: [
      {
        breakpoint: 1200,
        settings: {
  ...
  return (
    <>
      ...
      {/* /Breadcrumb */}
      {/* Content */}
      <div className="page-content content testimonial-section">
        <div className="container">
          <div className="testimonials-slider owl-carousel">
            <Slider {...testimonialCarousel}>
            {/* Testimonial -1 */}
            <div className="testimonial-sliders testimonial-slider-card">
              <div
                className="testimonial-item aos aos-init aos-animate"
                data-aos="fade-up"
              >
                ...
                <p className="mb-3">
                  ...
                  available. I've hired designers, writers, and developers, all
                  in one place.
                </p>
            ...
            <div className="testimonial-sliders testimonial-slider-card">
              ...
              >
                ...
                <p className="mb-3">
                  Thanks to this platform, I earn a stable working on my terms.
                  The gig marketplace is well-structured, making it easy to find
                  quality clients!
                </p>
                <div className="testimonial-review d-flex align-items-center justify-content-between">
                  <div className="testimonial-user p-0">
            ...
            <div className="testimonial-sliders testimonial-slider-card">
              ...
              >
                ...
                <p className="mb-3">
                  The job search is effortless, and payments are always on time.
                  I love the freedom this platform provides regular gigs
                  consistantly!
                </p>
                <div className="testimonial-review d-flex align-items-center justify-content-between">
                  <div className="testimonial-user p-0">
            ...
            <div className="testimonial-sliders testimonial-slider-card">
              ...
              >
                ...
                <p className="mb-3">
                  The review system and secure payments make hiring stress-free.
                  I always find talented freelancers who deliver quality work!
                </p>
                <div className="testimonial-review d-flex align-items-center justify-content-between">
                  <div className="testimonial-user p-0">
            ...
            <div className="testimonial-sliders testimonial-slider-card">
              ...
              >
                ...
                <p className="mb-3">
                  I wanted a fresh logo for my brand, and the The creative
                  process was seamless. The final logo perfectly represents my
                  business!
                </p>
                <div className="testimonial-review d-flex align-items-center justify-content-between">
                  <div className="testimonial-user p-0">
            ...
            <div className="testimonial-sliders testimonial-slider-card">
              ...
              >
                ...
                <p className="mb-3">
                  ...
                  hired delivered high-quality content. The articles were
                  well-researched.
                </p>
                <div className="testimonial-review d-flex align-items-center justify-content-between">
                  <div className="testimonial-user p-0">
