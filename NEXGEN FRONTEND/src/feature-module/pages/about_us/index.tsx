          ...
          <div className="col-lg-6">
            <div className="about-us-info">
              <div className="about-us-head">
                ...
                <p>
                  Welcome to DreamGigs, where innovation meets expertise. We are a
                ...
                <h5>Our Mission</h5>
                <p>
                  At DreamGigs, our mission is to empower individuals and
        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <div className="why-choose-card">
              ...
              <p>
                {" "}
                Our intuitive interface offers an effortless journey, through
                reliability from browsing services to booking and beyond.
              </p>
            </div>
          </div>
          <div className="col-lg-4">
            ...
            <div className="seller-info-content w-100">
              ...
              <div className="seller-feature-list d-flex w-100">
                <div className="sllers-list">
                  ...
                  <Link to={all_routes.signIn} className="btn btn-primary w-auto">
                    Become a Seller
                  </Link>
                </div>
              </div>
