...
import { talentPlans, talentComparison, talentFaq, talentTierNames } from './pricing-data';
...
const PricingTalent = () => {
  ...
  return (
    <div className="nex-pricing-page">
      {/* Hero */}
      <section className="nex-pricing-hero">
        <div className="nex-pricing-hero__container">
          <h1 className="nex-pricing-hero__title nex-title">PACKS TALENT</h1>
          <p className="nex-pricing-hero__subtitle">
            Choisis le pack qui correspond à tes ambitions et mets ta carrière sportive sous les projecteurs.
          </p>
          <Link to={all_routes.pricingRecruteur} className="nex-pricing-hero__switch">
            Vous êtes recruteur ? Voir les packs recruteur →
          </Link>
        </div>
      </section>
              ...
              >
                ...
                <div className="nex-plan__cta">
                  <Link
                    ...
                    className={`nex-btn ${plan.color === 'yellow' ? 'nex-btn--red' : 'nex-btn--yellow'}`}
                  >
                    Je choisis
                  </Link>
                </div>
            ...
            <table className="nex-comparison__table">
              <thead>
                <tr>
                  ...
                  <th className="nex-comparison__plan-col nex-comparison__plan-col--blue">{talentTierNames[0]}</th>
                  <th className="nex-comparison__plan-col nex-comparison__plan-col--yellow">{talentTierNames[1]}</th>
                  <th className="nex-comparison__plan-col nex-comparison__plan-col--red">{talentTierNames[2]}</th>
                </tr>
              </thead>
              <tbody>
                {talentComparison.map((row: ComparisonFeature, i: number) => (
