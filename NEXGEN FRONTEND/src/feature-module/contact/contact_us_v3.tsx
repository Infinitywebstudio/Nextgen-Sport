              ...
              <div className="contact-grid w-100">
                <div className="contact-content">
                  <div className="contact-icon">
                    <span>
                      <ImageWithBasePath src="assets/img/icons/contact-mail.svg" alt="Icon" />
                    </span>
                  </div>
                  <div className="contact-details">
                    <h6>Email Address</h6>
                    <p>
                      <Link to="#">dreamgigs@example.com</Link>
                    </p>
                    <p>
                      <Link to="#">dreamgigsinfo@example.com</Link>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 d-flex">
              <div className="contact-grid w-100">
                <div className="contact-content">
                  <div className="contact-icon">
                    <span>
                      <ImageWithBasePath src="assets/img/icons/contact-phone.svg" alt="Icon" />
                    </span>
                  </div>
                  <div className="contact-details">
                    <h6>Phone Number</h6>
            ...
            <div className="col-lg-4 col-md-6 d-flex">
              <div className="contact-grid w-100">
                <div className="contact-content">
                  <div className="contact-icon">
                    <span>
                      <ImageWithBasePath src="assets/img/icons/contact-map.svg" alt="Icon" />
                    </span>
                  </div>
